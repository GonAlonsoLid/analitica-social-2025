...
def get_imdb_reviews(movie_id: str = "tt16980178", max_reviews: int = 100) -> List[Dict]:
    ...
    Args:
        movie_id: ID de IMDB de la película (por defecto F1 2025)
    ...
    try:
        ...
        print(f"Error inesperado al obtener reseñas de IMDB: {e}")
        return []
...
if __name__ == "__main__":
    ...
    if reviews:
        ...
        print("No se pudieron obtener reseñas de IMDB")
